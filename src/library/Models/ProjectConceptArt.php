...
class ProjectConceptArt extends ActiveRecord\Model
{
    static $table_name = 'project_concept_art';
    ...
    public function to_json(array $options=array()) {
        ...
        # revisions
        $_revisions = ProjectConceptArtRevision::find_all_by_concept_art_id(
            $model->id, [
                'order' => 'sort_order'
            ]);
